...
public class TechSupportGuy extends Employee{
	...
	public void acceptableOrders() {
		Order a = new Order("Make_Schedule", 111);
		Order b = new Order("Replace_Grade", 222);
		Order c = new Order("Free_Classroom", 333);
		acceptable.add(a);
		acceptable.add(b);
		acceptable.add(c);
	}
	
	public TechSupportGuy(String name, String surname, String login, String password, int salary) {
