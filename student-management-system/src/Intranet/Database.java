...
public class Database {
	...
	public static void desCourses() throws IOException, ClassNotFoundException{
		FileInputStream fis = new FileInputStream("C:\\Users\\User\\eclipse-workspace\\sub-workspace\\Intranet\\src\\Intranet\\courses");
		ObjectInputStream oin = new ObjectInputStream(fis);
		courses = (Vector<Course>) oin.readObject();
	}
	public static void serCourses()throws IOException{
		FileOutputStream fos = new FileOutputStream("C:\\Users\\User\\eclipse-workspace\\sub-workspace\\Intranet\\src\\Intranet\\courses");
	...
	public static void desUsers() throws IOException, ClassNotFoundException{
		FileInputStream fis = new FileInputStream("C:\\Users\\User\\eclipse-workspace\\sub-workspace\\Intranet\\src\\Intranet\\userlist");
		ObjectInputStream oin = new ObjectInputStream(fis);
		users = (Vector<User>) oin.readObject();
	}
	public static void serUsers()throws IOException{
		FileOutputStream fos = new FileOutputStream("C:\\Users\\User\\eclipse-workspace\\sub-workspace\\Intranet\\src\\Intranet\\userlist");
		ObjectOutputStream oos = new ObjectOutputStream(fos);
